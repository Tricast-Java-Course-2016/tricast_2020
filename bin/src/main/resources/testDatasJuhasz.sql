...
INSERT INTO TIMEOFFCAL.worktimes(id, startTime, endTime, "type", "comment", modifiedBy, workDayId)
								VALUES(1, '2020-04-09 8:00', '2020-04-09 17:00', 'OFFICE', 'Normal Day', 1, 1);
...
INSERT INTO TIMEOFFCAL.worktimes(id, startTime, endTime, modifiedStartTime, modifiedEndTime, "type", "comment", modifiedBy, workDayId)
								VALUES(2, '2020-04-09 8:00', '2020-04-09 17:00', '2020-04-10 9:00', '2020-04-10 18:00', 'HOMEOFFICE', 'Happy Day', 1, 2);
INSERT INTO TIMEOFFCAL.worktimes(id, startTime, endTime, "type", "comment", modifiedBy, workDayId)
								VALUES(3, '2020-05-09 8:00', '2020-05-09 17:00', 'DELEGACY', 'Normal Day', 1, 3);
INSERT INTO TIMEOFFCAL.worktimes(id, startTime, endTime, modifiedStartTime, modifiedEndTime, "type", "comment", modifiedBy, workDayId)
								VALUES(4, '2020-05-09 8:00', '2020-05-09 17:00', '2020-05-10 9:00', '2020-05-10 18:00', 'OFFICE', 'Happy Day', 1, 4);
...
INSERT INTO TIMEOFFCAL.offDays(id, "date", "type", status, approvedBy, userId, startTime, endTime)
								Values(1, '2020-04-13', 'PAID', 'APPROVED', 1, 1, '2020-04-13 8:00', '2020-04-13 12:00');
INSERT INTO TIMEOFFCAL.offDays(id, "date", "type", status, approvedBy, userId, startTime, endTime)
								Values(2, '2020-04-14', 'SICK', 'APPROVED', 1, 1, '2020-04-14 8:00', '2020-04-14 17:00');

INSERT INTO TIMEOFFCAL.offDays(id, "date", "type", status, approvedBy, userId, startTime, endTime)
								Values(3, '2020-05-13', 'OTHER', 'APPROVED', 1, 2, '2020-05-13 8:00', '2020-05-13 12:00');
INSERT INTO TIMEOFFCAL.offDays(id, "date", "type", status, approvedBy, userId, startTime, endTime)
								Values(4, '2020-05-14', 'PAID', 'APPROVED', 1, 2, '2020-05-14 8:00', '2020-05-14 17:00');




INSERT INTO TIMEOFFCAL.offDayLimits(id, "year", maximumAmount, "type", userId)
									VALUES(1, '2020', 20, 'PAID', 1);
INSERT INTO TIMEOFFCAL.offDayLimits(id, "year", maximumAmount, "type", userId)
									VALUES(2, '2021', 21, 'PAID', 1);

INSERT INTO TIMEOFFCAL.offDayLimits(id, "year", maximumAmount, "type", userId)
									VALUES(3, '2020', 22, 'PAID', 2);
INSERT INTO TIMEOFFCAL.offDayLimits(id, "year", maximumAmount, "type", userId)
									VALUES(4, '2021', 23, 'PAID', 2);
