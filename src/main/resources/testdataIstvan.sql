...
INSERT INTO timeoffcal.offDays (id, "date", "type", status, approvedBy, userId, startTime, endTime)
VALUES (2, to_date('20200305','YYYYMMDD'), 'SICK', 'REQUESTED', DEFAULT, 2, TO_TIMESTAMP('2020 Mar 05 00:01','YYYY MON DD HH24:MI'), TO_TIMESTAMP('2020 Mar 05 23:59','YYYY MON DD HH24:MI'));
