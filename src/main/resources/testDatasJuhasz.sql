...
INSERT INTO TIMEOFFCAL.permissions(id, permissionName) VALUES(1, 'everything');
INSERT INTO TIMEOFFCAL.permissions(id, permissionName) VALUES(2, 'not everything');
...
INSERT INTO TIMEOFFCAL.worktimes(id, startTime, endTime, "type", "comment", modifiedBy, workDayId)
								VALUES(1, '2020-04-10 8:00', '2020-04-09 17:00', 'normal', 'Stinky Day', 1, 1);
INSERT INTO TIMEOFFCAL.worktimes(id, startTime, endTime, modifiedStartTime, modifiedEndTime, "type", "comment", modifiedBy, workDayId)
								VALUES(2, '2020-04-10 8:00', '2020-04-09 17:00', '2020-04-10 9:00', '2020-04-10 18:00', 'normal', 'Stinky Day', 1, 2);

INSERT INTO TIMEOFFCAL.worktimes(id, startTime, endTime, "type", "comment", modifiedBy, workDayId)
								VALUES(3, '2020-04-10 8:00', '2020-04-09 17:00', 'normal', 'Stinky Day', 1, 3);
INSERT INTO TIMEOFFCAL.worktimes(id, startTime, endTime, modifiedStartTime, modifiedEndTime, "type", "comment", modifiedBy, workDayId)
								VALUES(4, '2020-04-10 8:00', '2020-04-09 17:00', '2020-04-10 9:00', '2020-04-10 18:00', 'normal', 'Stinky Day', 1, 4);
...
INSERT INTO TIMEOFFCAL.offDays(id, "date", "type", status, approvedBy, userId, startTime, endTime)
								Values(2, '2020-04-14', 'freeday', 'accepted', 1, 1, '2020-04-14 8:00', '2020-04-22 00:00');

INSERT INTO TIMEOFFCAL.offDays(id, "date", "type", status, approvedBy, userId, startTime, endTime)
								Values(3, '2020-05-13', 'freeday', 'accepted', 1, 2, '2020-04-13 8:00', '2020-04-13 12:00');
INSERT INTO TIMEOFFCAL.offDays(id, "date", "type", status, approvedBy, userId, startTime, endTime)
								Values(4, '2020-06-14', 'freeday', 'accepted', 1, 2, '2020-04-14 8:00', '2020-04-22 00:00');
